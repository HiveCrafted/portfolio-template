Gem::Specification.new do |spec|
  spec.name                    = "portfolio-template-jekyll-theme"
  spec.version                 = "2.2.2"
  spec.authors                 = ["Hive Craft"]
  spec.email                   = ["HiveCrafted@gmail.com"]

  spec.summary                 = "A beautiful portfolio Jekyll theme."
  spec.homepage                = "https://github.com/HiveCrafted/portfolio-template"
  spec.license                 = "MIT"
